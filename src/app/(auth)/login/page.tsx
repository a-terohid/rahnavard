...
export const metadata: Metadata = {
  ...
  description:
    "به حساب کاربری خود در رهنورد وارد شوید و خرید، فروش و اجاره لوازم کمپینگ و کوهنوردی را مدیریت کنید. همین حالا وارد شوید و ماجراجویی خود را ادامه دهید.",
  keywords: [
    "ورود رهنورد",
    "لاگین رهنورد",
    "ورود کمپینگ",
    ...
    images: [
      {
        ...
        height: 630,
        alt: "ورود به رهنورد - خرید، فروش و اجاره لوازم کمپینگ و کوهنوردی",
      },
    ],
  },
  twitter: {
