...
export const metadata: Metadata = {
  ...
  description:
    "در رهنورد ثبت‌نام کنید و خرید، فروش و اجاره لوازم کمپینگ و کوهنوردی را به راحتی انجام دهید. همین حالا حساب کاربری خود را بسازید و ماجراجویی خود را آغاز کنید.",
  keywords: [
    "ثبت‌نام رهنورد",
    ...
    images: [
      {
        ...
        height: 630,
        alt: "ثبت‌نام در رهنورد - خرید، فروش و اجاره لوازم کمپینگ و کوهنوردی",
      },
    ],
  },
  twitter: {
